...
buildah run $container make -j$(nproc --ignore 1) rockchip/rk3399-nanopi-r4s.dtb
...
buildah unshare ./$copy_script linux/arch/arm64/boot/dts/rockchip/rk3399-nanopi-r4s.dtb dtb_nanopi-r4s.dtb
rm ./$copy_script
